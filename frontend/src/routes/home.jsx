  ...
  return (
    <>
      ...
      <div className="container1">
        <div className="backgroundH-image">
          <div ref={contentBox} className="contentH-box">
            ...
            <p>
              Rodeado de espacios verdes, EventCraft es una alternativa
              diferente, que frece un servicio personalizado y de excelencia,
              donde podrás encontrar profesionalismo y calidez. Inmerso en un
              amplio parque, sus alrededores y vistas son incomparables.
            </p>
            <button
      ...
      <div className="container2">
        <h2>Salones con versatilidad para adaptarse a diferentes formatos.</h2>
        <button
          className="info-button"
          onClick={() => navigate("/salonesCliente")}
        >
          Conocé más
        </button>
      </div>
      ...
      <div className="image-buttons-container">
        <div className="image-container">
          ...
          <button
            ...
            onClick={() => navigate("/eventosSociales")}
          >
            Eventos Sociales
          </button>
        </div>
        <div className="image-container">
          ...
          <button
            className="image-button"
            onClick={() => navigate("/eventosCorporativos")}
          >
